    ...
    * which are converted into pieces using distribution qty mode semantics.
    ...
    public function fetchAllStockItems($dailyStockId)
    {
        $stockItems = $this->where('daily_stock_id', $dailyStockId)
            ->select('daily_stock_items.*, products.product_name, products.category, product_costs.selling_price, product_costs.selling_price_per_piece, product_costs.direct_cost, product_costs.overhead_cost_amount, product_costs.pieces_per_yield')
