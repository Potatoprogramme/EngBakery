                    ...
                    <div class="max-w-md mx-auto">
                        ...
                        <form class="space-y-4" action="<?= base_url('Login/Manual') ?>" method="post" novalidate>
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <input id="password" name="password" type="password" required
                                        class="w-full px-3 py-2 pr-10 rounded-lg border border-gray-300 bg-white text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#007B4C] focus:border-transparent"
                            ...
                            <a href="<?= base_url('Auth/Google') ?>"
                                class="w-full inline-flex items-center justify-center px-4 py-2 bg-white border border-gray-300 hover:bg-gray-50 text-gray-700 font-semibold rounded-lg focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-[#007B4C]">
