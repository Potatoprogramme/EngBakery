                        ...
                        <div class="mb-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div class="bg-gray-50 p-3 rounded-lg">
                                    <label class="block text-xs font-medium text-gray-500 uppercase mb-1">User
                                        ID</label>
                                    <p class="text-sm font-medium text-gray-900" id="user_id_display">-</p>
                                </div>

                                <div class="bg-gray-50 p-3 rounded-lg">
                                    <label class="block text-xs font-medium text-gray-500 uppercase mb-1">Employee
                                        Type</label>
                                    <p class="text-sm font-medium text-gray-900" id="employee_type_display">-</p>
                                </div>

                                <div class="bg-gray-50 p-3 rounded-lg">
                                    <label class="block text-xs font-medium text-gray-500 uppercase mb-1">Account
                                        Status</label>
                ...
                <div id="notificationSection" class="lg:col-span-2 settings-content hidden">
                    <div class="bg-white rounded-lg shadow-md overflow-hidden">
                        ...
                        <form id="notificationForm" class="p-6">
                            <p class="text-sm text-gray-600 mb-5">Control which email reports your owner account receives.
                            </p>
                            ...
                            <div class="space-y-4">
                                <label class="flex items-center justify-between p-4 border border-gray-200 rounded-lg">
                                    <div>
                                        ...
                                        <p class="text-xs text-gray-500">Receive alert emails when product/raw material
                                            stock is low.</p>
                                    </div>
                                    <input type="checkbox" id="low_stock_enabled"
                                        class="w-5 h-5 text-primary rounded border-gray-300 focus:ring-primary" checked>
                                </label>

                                <label class="flex items-center justify-between p-4 border border-gray-200 rounded-lg">
                                    <div>
                                        <p class="text-sm font-semibold text-gray-800">Send Inventory Reports</p>
                                        <p class="text-xs text-gray-500">Receive inventory report emails from
                                            manual/scheduled sends.</p>
                                    </div>
                                    <input type="checkbox" id="inventory_enabled"
                                        class="w-5 h-5 text-primary rounded border-gray-300 focus:ring-primary" checked>
                                </label>
                                ...
                                <label class="flex items-center justify-between p-4 border border-gray-200 rounded-lg">
                                    ...
                                    <input type="checkbox" id="remittance_enabled"
                                        class="w-5 h-5 text-primary rounded border-gray-300 focus:ring-primary" checked>
                                </label>
                                ...
                                <label class="flex items-center justify-between p-4 border border-gray-200 rounded-lg">
                                    <div>
                                        ...
                                        <p class="text-xs text-gray-500">Receive an email whenever material stock is added
                                            or changed.</p>
                                    </div>
                                    <input type="checkbox" id="material_stock_logs_enabled"
                                        class="w-5 h-5 text-primary rounded border-gray-300 focus:ring-primary" checked>
                                </label>

                                <label class="flex items-center justify-between p-4 border border-gray-200 rounded-lg">
                                    <div>
                                        <p class="text-sm font-semibold text-gray-800">Send Beginning Quantity Adjustments
                                        </p>
                                        <p class="text-xs text-gray-500">Receive an email when an inventory beginning
                                            quantity changes.</p>
                                    </div>
                                    <input type="checkbox" id="beginning_quantity_adjustments_enabled"
                                        class="w-5 h-5 text-primary rounded border-gray-300 focus:ring-primary" checked>
                                </label>
                            </div>
