...
<body class="bg-gray-50">
        ...
        <div
            ...
            <form id="editInventoryForm" class="flex-1 overflow-y-auto pr-1">
                ...
                <div class="mb-4 hidden" id="editEndingGroup">
                    ...
                    <p id="editEndingHint" class="text-xs text-gray-400 mt-1">Enter the actual final ending stock count.</p>
                </div>
    ...
    function checkIfInventoryExists() {
        ...
        function applyEditedInventoryItemLocally(itemId, payload, isAdjustmentMode) {
            ...
            const oldEnding = parseInt(item.ending_stock) || 0;
            ...
            if (isAdjustmentMode) {
                ...
                const projectedEnding = Math.max(0, oldEnding + beginningInput);
                ...
                item.ending_stock = projectedEnding;
        ...
        $(document).on('click', '.btn-edit', function () {
            ...
            if (item) {
                ...
                if (isAdjustmentMode) {
                    ...
                    $('#editEndingHint').text('Auto-calculated: current ending + beginning adjustment.');

                    // Beginning and pull out are adjustments; ending auto-follows beginning adjustment.
                    $('#editBeginningStock').val(0).removeAttr('min');
                    $('#editPullOutQuantity').val(0).attr('min', 0);
                    $('#editEndingStock').val(endingStock).attr('min', 0).prop('readonly', true).addClass(
        ...
        function updateRemainingPreview() {
            ...
            if (isAdjustmentMode) {
                ...
                projectedRemaining = Math.max(0, oldEnding + beginningInput);
                ...
                $('#editEndingStock').val(projectedRemaining);
        ...
        $('#editInventoryForm').on('submit', function (e) {
            ...
            if (isAdjustmentMode) {
                ...
                $('#editEndingStock').val(projectedEnding);
