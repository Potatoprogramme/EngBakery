                ...
                <div class="flex flex-wrap items-center justify-between gap-3 w-full">
                    ...
                    <div class="flex flex-wrap items-center gap-2">
                        ...
                        <button id="btnResetInventoryForNextShift" onclick="openResetModal()"
                            class="inline-flex h-10 items-center rounded-lg border border-yellow-200 bg-yellow-50 px-4 text-sm font-medium text-yellow-700 hover:bg-yellow-100 focus:ring-2 focus:ring-yellow-300 transition">
