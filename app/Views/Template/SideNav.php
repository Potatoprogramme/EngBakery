        ...
        <div class="flex items-center justify-between">
            <div class="flex items-center justify-start rtl:justify-end">
                ...
                <a href="<?= base_url("/Dashboard") ?>"
                    class="flex items-center justify-center ms-2 sm:ms-4 md:me-24 min-w-0">
                    ...
                    <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded shadow"
                        ...
                        <div class="px-4 py-3" role="none">
                            <p class="text-sm text-gray-900" role="none">
                                <?= session('username') ?> - <?= ucfirst(session('employee_type')) ?>
                            </p>
...
<aside id="logo-sidebar"
    class="fixed top-0 left-0 z-40 w-60 h-screen pt-[70px] sm:pt-[60px] transition-transform -translate-x-full bg-white border-r border-gray-200 sm:translate-x-0"
    aria-label="Sidebar">
        ...
        <ul class="space-y-2 font-medium flex-1">
            ...
            <li class="pt-2 mt-2 border-t border-gray-100">
                <a href="<?= base_url('MaterialStock') ?>"
                    ...
                    <svg class="w-6 h-6 <?= ($current === 'materialstock') ? 'text-white' : 'text-gray-900' ?> transition duration-300 group-hover:text-gray-200"
                        aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                        stroke="currentColor" stroke-width="2">
                        <path stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <span
                        class="flex-1 ms-3 whitespace-nowrap group-hover:text-gray-200 transition-colors duration-300 <?= ($current === 'materialstock') ? 'text-white' : '' ?>">Material
                        Stock</span>
                </a>
            </li>
            <?php if (session('employee_type') === 'admin' || session('employee_type') === 'owner'): ?>
            ...
            <li class="pt-2 mt-2 border-t border-gray-100">
                <a href="<?= base_url('Inventory') ?>"
                    class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-secondary group transition-colors duration-300 <?= ($current === 'inventory') ? 'bg-primary' : '' ?>">
                    <svg class="w-6 h-6 <?= ($current === 'inventory') ? 'text-white' : 'text-gray-900' ?> transition duration-300 group-hover:text-gray-200"
                        aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                        stroke="currentColor" stroke-width="2">
                        <path stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <span
                        class="flex-1 ms-3 whitespace-nowrap group-hover:text-gray-200 transition-colors duration-300 <?= ($current === 'inventory') ? 'text-white' : '' ?>">Inventory</span>
                </a>
            </li>
            <li class="pt-2 mt-2 border-t border-gray-100">
                <a href="<?= base_url('Order') ?>"
                    class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-secondary group transition-colors duration-300 <?= ($current === 'order') ? 'bg-primary' : '' ?>">
                    <svg class="w-6 h-6 <?= ($current === 'order') ? 'text-white' : 'text-gray-900' ?> transition duration-300 group-hover:text-gray-200"
                        aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                        stroke="currentColor" stroke-width="2">
                        <path stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <span
                        class="flex-1 ms-3 whitespace-nowrap group-hover:text-gray-200 transition-colors duration-300 <?= ($current === 'order') ? 'text-white' : '' ?>">Order</span>
                </a>
            </li>
