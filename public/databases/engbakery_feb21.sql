...
(7, 'bakery', 'test1', '', 0, '2026-02-15 04:47:58', NULL),
(8, 'grocery', '200 ml Bottled Water', '', 0, '2026-02-21 09:36:46', NULL),
...
(432, 339, 100, 0, 'grams', '2026-02-21 09:09:11');
...
--
ALTER TABLE `daily_stock`
  MODIFY `daily_stock_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;
...
--
ALTER TABLE `distributions`
  MODIFY `distribution_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=38;
...
--
ALTER TABLE `product_costs`
  MODIFY `product_cost_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
