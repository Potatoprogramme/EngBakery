...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 30, 2026 at 03:03 PM
...
--
-- Dumping data for table `order_item_id`
--

INSERT INTO `order_item_id` (`order_item_id`, `product_id`, `order_id`, `amout`, `cost_per_item`, `total_cost_of_item`, `date_created`, `time_created`) VALUES
...
(2, '', 'Pandecoco', '', '2026-01-29 14:15:07'),
...
CREATE TABLE `remittance_details` (
  ...
  `overage_shortage` double NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
ALTER TABLE `daily_stock`
  MODIFY `daily_stock_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `product_costs`
  MODIFY `product_cost_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `product_recipe`
--
ALTER TABLE `product_recipe`
  MODIFY `recipe_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=108;
