...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 01, 2026 at 01:32 PM
...
INSERT INTO `daily_stock_items` (`item_id`, `daily_stock_id`, `product_id`, `beginning_stock`, `pull_out_quantity`, `ending_stock`, `is_enabled`, `notes`) VALUES
(65, 31, 1, 0, 0, 0, 0, NULL),
(66, 31, 2, 0, 0, 0, 0, NULL),
(67, 31, 3, 0, 0, 0, 0, NULL),
(68, 31, 4, 0, 0, 0, 0, NULL),
(69, 31, 5, 0, 0, 0, 0, NULL),
(71, 31, 8, 0, 0, 0, 0, NULL),
(72, 31, 11, 0, 0, 0, 0, NULL),
(73, 31, 12, 0, 0, 0, 0, NULL),
(74, 31, 13, 2, 0, 0, 0, NULL),
(75, 31, 7, 0, 0, 0, 0, NULL),
(76, 32, 1, 0, 0, 0, 0, NULL),
(77, 32, 2, 0, 0, 0, 0, NULL),
(78, 32, 3, 0, 0, 0, 0, NULL),
(79, 32, 4, 0, 0, 0, 0, NULL),
(80, 32, 5, 0, 0, 0, 0, NULL),
(81, 32, 8, 0, 0, 0, 0, NULL),
(82, 32, 11, 0, 0, 0, 0, NULL),
(83, 32, 12, 0, 0, 0, 0, NULL),
(84, 32, 13, 10, 0, 10, 0, NULL),
(240, 53, 1, 0, 0, 0, 0, NULL),
(241, 53, 2, 0, 0, 0, 0, NULL),
(242, 53, 3, 0, 0, 0, 0, NULL),
(243, 53, 4, 0, 0, 0, 0, NULL),
(244, 53, 5, 0, 0, 0, 0, NULL),
(245, 53, 7, 0, 0, 0, 0, NULL),
(246, 53, 8, 0, 0, 0, 0, NULL),
(247, 53, 11, 0, 0, 0, 0, NULL),
(248, 53, 12, 0, 0, 0, 0, NULL),
(249, 53, 13, 10, 0, 10, 0, 'test lang');
...
(375, 338, 250, 0, 'grams', '2026-03-01 12:03:48'),
(431, 340, 3000, 10, 'grams', '2026-02-17 08:12:11'),
(432, 339, 2000, 7.3333, 'grams', '2026-03-01 12:03:53');
...
--
ALTER TABLE `daily_stock`
  MODIFY `daily_stock_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=54;
...
--
ALTER TABLE `raw_materials`
  MODIFY `material_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=342;

--
-- AUTO_INCREMENT for table `raw_material_cost`
--
ALTER TABLE `raw_material_cost`
  MODIFY `cost_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=432;
