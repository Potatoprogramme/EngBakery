    ...
    <div class="col-md-6">
        <div class="card">
            <div class="card-header py-2">
                <i class="fas fa-plus me-2"></i><?= esc($title) ?>
            </div>
            <div class="card-body">
                <form action="<?= site_url('RawMaterials/store') ?>" method="post">
                    <?= csrf_field() ?>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control form-control-sm" name="material_name" 
                               value="<?= old('material_name') ?>" placeholder="e.g., Flour - All Purpose" required>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-4 mb-3">
                            ...
                            <input type="number" class="form-control form-control-sm" name="material_quantity" id="material_quantity"
                                   value="<?= old('material_quantity') ?>" placeholder="25000" min="1" required>
                        </div>
                        <div class="col-4 mb-3">
                            ...
                            <input type="number" class="form-control form-control-sm" name="total_cost" id="total_cost"
                                   value="<?= old('total_cost') ?>" placeholder="1350.00" step="0.01" min="0.01" required>
                            <small class="text-muted">per quantity</small>
                        </div>
                        <div class="col-4 mb-3">
                            <label class="form-label">Per Gram/PC</label>
                            <div class="form-control form-control-sm" id="cost_per_unit_display">₱0.000</div>
